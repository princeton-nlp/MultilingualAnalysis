...
LANG="ar"
EVAL="_zero"
MODEL_DIR="one_to_one_mapping_75_500K"
MODEL="../../../../bucket/model_outputs/${LANG}/${MODEL_DIR}/mlm"
OUTPUT_DIR="../../../../bucket/model_outputs/${LANG}/${MODEL_DIR}/"
RUN_NAME="${LANG}_${MODEL_DIR}_"
ZERO_SHOT_ADD="--one_to_one_mapping --one_to_one_file ../../synthetic_language_files/word_based/configuration_files/one_to_one_mapping_random_40000_fraction_75.npy --word_modification replace"
