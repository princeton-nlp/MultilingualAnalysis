...
python ../../transformers/examples/xla_spawn.py --num_cores 1 ../../transformers/examples/text-classification/run_xnli_synthetic.py \
  --model_name_or_path ../../../../bucket/model_outputs/wikitext/english_word_modification_one_to_one/ \
  --language fr \
  ...
  --output_dir ../../../../bucket/model_outputs/xnli/$TASK_NAME$RUN_NO/ \
  --run_name $RUN_NAME \